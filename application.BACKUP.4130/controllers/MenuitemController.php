        ...
        $menu = $this->_request->getParam('menu'); 
        		...
        		if ($this->_request->isPost()) { 
        			if ($frmMenuItem->isValid($_POST)) { 
        				...
        				$mdlMenuItem->addItem($data['menu_id'], $data['label'], $data['link_type'],
        					$data['page_cat'],$data['page_id'], $data['link']); 
...
{ 
    ...
    if ($this->_request->isPost()) { 
        if ($frmMenuItem->isValid($_POST)) { 
            $data = $frmMenuItem->getValues(); 
            $mdlMenuItem->updateItem($data['id'],  $data['label'], $data['link_type'],
        					$data['page_cat'],$data['page_id'], $data['link']); 
            $this->_request->setParam('menu', $data['menu_id']); 
